...
function About() {
    ...
    <div className='About'>
        ...
        <p>
            ...
            <div className='Box'>
            <h2>Tem 5 títulos invictos (1958, 1962, 1970, 1994 e 2002) e quatro títulos da Copa das Confederações
            FIFA (1997, 2005, 2009 e 2013)</h2>
            </div>
            </div>
        <img src={arquibancada} alt="arquibancada com bandeira do brasil"/>
